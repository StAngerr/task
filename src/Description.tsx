...
export const Description = () => {
    return <div>
        <h3>Task:</h3>
        <ul>
            <li>Add SVG to the view with two buttons 'Toggle angle' and 'Select Location Color'</li>
            <li>The toggle angle button should rotate the whole SVG on 180-degree angle smoothly (use animation)</li>
            <li>Select location color, should be a select control with three options (Red, Green, Blue pick any shades you want)</li>
            <li>After selecting any of options, highlighted location should change color (rectangle <u>inside SVG</u> should become red, green or blue)</li>
        </ul>
        ...
        <p><u>Note that highlighted location is polygon inside SVG file</u></p>
